...
class PhobosVisibility:
    """
    Visibility region on the Martian surface using the spherical law of cosines:

        cos(alpha) = cos(theta) * cos(phi - phi0)

    where alpha is the maximum elevation angle to Phobos, theta is surface
    latitude, phi is surface longitude, and phi0 is the sub-satellite longitude.
  """
